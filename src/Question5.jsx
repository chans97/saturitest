...
function Question5({ name, url, setStage, stage }) {
      ...
      <section className={styles.main}>
        <div className={styles.layer}>
          ...
          <h4 className={styles.info}>
            자이로드롭을 겨우 타고 온 당신..
            <br />
            밥을 먹고 있는데 앞에 앉은 친구가 <br />
            먹으라는 밥은 안 먹고 시끄럽게 떠든다.
          </h4>
          ...
          <section ref={speechContainer} className={styles.speechContainer}>
            ...
            <div className={styles.speechBox}>
              <div className={styles.text_box}>
                ...
                >
                  <strong id="strong">고마쎼리마주디를주잡아쨰뿔라</strong>
                </span>
              </div>
            </div>
          </section>
